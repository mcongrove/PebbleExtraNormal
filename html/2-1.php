...
<html>
<head>
<title>"Extra Normal" Configuration</title>
<meta charset="utf-8">
...
<body>
	<div class="container">
		<div id="themes">
			...
			<ul>
				<li id="theme-dark"<?php echo $_GET['theme'] == 'dark' || !$_GET['theme'] ? ' class="selected"' : ''; ?>>
					<img src="extra-normal-dark.png" />
					
					<div />
				</li>
				<li id="theme-light"<?php echo $_GET['theme'] == 'light' ? ' class="selected"' : ''; ?>>
					<img src="extra-normal-light.png" />
		...
		<div id="buttons">
			...
			<h5>
				"Extra Normal" watchface for Pebble, developed by Matthew Congrove
			</h5>
